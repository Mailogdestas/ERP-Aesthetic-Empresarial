...
export default function PlanosPage() {
  ...
  useEffect(() => {
    api.get('/planos?barbeariaId=tenant-1').then((r) => setLista(r.data ?? []));
  }, []);
  return (
    <>
      <Heading size="md" mb={4}>Planos</Heading>
      <HStack mb={4}><Button colorScheme="brand">Novo Plano</Button></HStack>
